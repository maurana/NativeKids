      ...
      <NativeBaseProvider theme={theme}>
        <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center',  }} bg={'warning.50'}>
          <Container>
          {
            ...
            <>
            <HStack space={10} justifyContent="center">
            <Pressable onPress={() => navigation.navigate('PlayHurufScreen', {data: 1})} h="20" w="40" alignItems={'center'} justifyContent={'center'}><Image source={require('../assets/huruf.png')} alt='image' width={'100%'} height={50}/></Pressable>
